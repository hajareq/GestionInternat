                    ...
                    <div class="ml-auto text-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a>Update Rooms</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col d-flex justify-content-center">
                <div class="card">
                    <form class="form-horizontal">
                        <div class="card-body">
                            <h4 class="card-title">Enter Room ID:</h4>
                            <br/>
                            <br/>
                            <br/>
                            <div class="form-group row">
                                <label for="fname" class="col-sm-4 text-right control-label col-form-label">Room ID</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="fname" placeholder="Room ID Here">
                                </div>
                            </div>
                            <br/>
                        </div>
                        <div class="col d-flex justify-content-center">
                            <div class="border-top">
                                <div class="card-body">
                                    <button type="button" class="btn btn-primary btn-lg" onclick="location.href='./adminupdateroom';">Search</button>
                                </div>
                            </div>
                        </div>
                    </form>
