...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">New Room</h4>
                    <div class="ml-auto text-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="adminhome.jsp">Home</a></li>
                                <li class="breadcrumb-item active"><a>Insert New Room</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <!-- ============================================================== -->
            <div class="card">
                <form class="form-horizontal" method="post" action="./AdminNewRoom">
                    <%
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="roomId" class="form-control" id="fname" placeholder="Room ID Here">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Floor ID</label>
                            <div class="col-sm-9">
                                <input type="text" name="codeEtage" class="form-control" id="fname" placeholder="Floor ID Here">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 text-right control-label col-form-label">Number of Residants</label>
                            <div class="col-sm-9">
                                <input type="number" min="1" max="4" name="nb" class="form-control" id="lname" placeholder="Number of Residants Here">
                            </div>
                        </div>
                    </div>
