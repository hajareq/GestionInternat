...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="ml-auto text-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="adminclaims.jsp">Claims</a></li>
                                <li class="breadcrumb-item active"><a>Claim</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            <form class="form-control" method="get" action="./ClaimsAdmin">
            <!-- ============================================================== -->
            <!-- Start Page Content -->
            <!-- ============================================================== -->
            <div class="row">
                ...
                <div class="col-lg-3  col-md-3">
                    <div class="blog_info text-right">
                        <div class="post_tag">
                            ...
                            <br/>
                            <br/>
                            <a><%=claim.getCategory()%></a>
                        </div>
                        <ul class="blog_meta list">
                            <li><a><%=claim.getStd().getName()%><i class="lnr lnr-user"></i></a></li>
                            <li><a>E<i class="lnr lnr-apartment"></i></a></li>
                            <li><a>304<i class="lnr lnr-enter"></i></a></li>
                            <li><a><%=claim.getDate()%><i class="lnr lnr-calendar-full"></i></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9 col-md-9">
                    <div class="section-top-border">
                        <h3 class="mb-30 title_color">Claim Body</h3>
                        <div class="row">
                            <div class="col-lg-12">
            ...
            <div class="comment-footer float-right" >
                <button type="submit" class="btn btn-success btn-lg" value="<%=claim.getId()%>">Validate</button>
                <button type="submit" class="btn btn-danger btn-lg" value="<%=claim.getId()%>" >Delete</button>
            </div>
            <!-- ============================================================== -->
            <!-- End PAge Content -->
            <!-- ============================================================== -->
