...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-12 d-flex no-block align-items-center">
                    <h4 class="page-title">New Building</h4>
                    <div class="ml-auto text-right">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="./HomeAdmin" >Home</a></li>
                                <li class="breadcrumb-item active"><a>Insert New Building</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container-fluid">
            ...
            <!-- ============================================================== -->
            <div class="card">
                <form class="form-horizontal" method="post" action="./AdminNewBuilding">
                   <%
                    ...
                    %>
                    <div class="card-body">
                        <h4 class="card-title">Building Info</h4>
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Building ID</label>
                            <div class="col-sm-9">
                                <input type="text" name="Code" class="form-control" id="fname" placeholder="Building ID Here">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 text-right control-label col-form-label">Gender</label>
                            <div class="col-sm-9">
                                <input type="text" name="gender" class="form-control" id="lname" placeholder="Gender Here">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="lname" class="col-sm-3 text-right control-label col-form-label">Number of Floors</label>
                            <div class="col-sm-9">
                                <input type="number" name="floorNb" class="form-control" id="lname" placeholder="Number of Floors Here">
                            </div>
                        </div>
                    </div>
